...
public class MainActivity extends ActionBarActivity {
    ...
    public WeatherActivity mWeatherActivity;
...
//                        ((SimpleCard) card).setTitle("CHANGED ON RUNTIME");
            ...
            case 10:
                ...
                card = new WeatherCard(mWeatherActivity);
                card.setTitle("Weather");
                card.setDescription("What's the forcast?");
                card.setTag("WEATHER_CARD");
                ((WeatherCard)card).getFormattedTime(R.id.time_label);
                ((WeatherCard)card).getHumidity();
                ((WeatherCard)card).getTemperature(R.id.temperature_label);
                ((WeatherCard) card).setSubtitle("Check the weather in your area");
                ((WeatherCard) card).setButtonText("Forcast");
                ((WeatherCard) card).setOnButtonPressedListener(new OnButtonPressListener() {
                    @Override
                    public void onButtonPressedListener(View view, Card card) {
                ...
                if (position % 2 == 0)
                    ((WeatherCard) card).setBackgroundColorRes(R.color.background_material_dark);
                card.setDismissible(true);
