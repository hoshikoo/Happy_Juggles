...
public class SportsActivity extends Activity {
    ...
    // Movies json url
    private static final String url = "http://worldcup.sfg.io/teams/results";
    private ProgressDialog pDialog;
    private List<Sports> resultList = new ArrayList<Sports>();
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                sports.setCountry(obj.getString("country"));
                                sports.setWins(obj.getInt("wins"));
